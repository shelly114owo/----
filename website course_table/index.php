	...
	<div class="container">
	    ...
	    <div class="container">
			<ul class="nav nav-tabs mt-3">
				...
				<li class="nav-item">
					<a class="nav-link" data-bs-toggle="tab" href="#alreadychoose">已選課程列表</a>
				</li>
				<li class="nav-item">
					<a class="nav-link" data-bs-toggle="tab" href="#canchoose">可選課程列表</a>
				</li>
				<li class="nav-item">
					<a class="nav-link" data-bs-toggle="tab" href="#studlogin">課表</a>
				</li>
			</ul>
